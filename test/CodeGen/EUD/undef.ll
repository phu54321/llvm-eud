...
@routing = global %struct.eud_map_def { i32 1, i32 6, i32 12, i32 1024 }, section "maps", align 4
@routing_miss_0 = global %struct.eud_map_def { i32 1, i32 1, i32 12, i32 1 }, section "maps", align 4
@test1 = global %struct.eud_map_def { i32 2, i32 4, i32 8, i32 1024 }, section "maps", align 4
@test1_miss_4 = global %struct.eud_map_def { i32 2, i32 1, i32 8, i32 1 }, section "maps", align 4
@_license = global [4 x i8] c"GPL\00", section "license", align 1
@llvm.used = appending global [6 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (i32 (%struct.__sk_buff*)* @eeud_filter to i8*), i8* bitcast (%struct.eud_map_def* @routing to i8*), i8* bitcast (%struct.eud_map_def* @routing_miss_0 to i8*), i8* bitcast (%struct.eud_map_def* @test1 to i8*), i8* bitcast (%struct.eud_map_def* @test1_miss_4 to i8*)], section "llvm.metadata"

; Function Attrs: nounwind uwtable
define i32 @eeud_filter(%struct.__sk_buff* nocapture readnone %eeud_packet) #0 section "socket1" {
...
; CHECK: r2 += -8
; CHECK: r1 = routing
; CHECK: call eud_map_lookup_elem
; CHECK: exit
  ...
  %8 = call i32 (%struct.eud_map_def*, %struct.routing_key_2*, ...) bitcast (i32 (...)* @eud_map_lookup_elem to i32 (%struct.eud_map_def*, %struct.routing_key_2*, ...)*)(%struct.eud_map_def* nonnull @routing, %struct.routing_key_2* nonnull %key) #3
  ret i32 undef
}
...
declare i32 @eud_map_lookup_elem(...) #2

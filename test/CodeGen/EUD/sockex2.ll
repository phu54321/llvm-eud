...
@hash_map = global %struct.eud_map_def { i32 1, i32 4, i32 8, i32 1024 }, section "maps", align 4

; Function Attrs: nounwind uwtable
define i32 @eud_prog2(%struct.sk_buff* %skb) #0 section "socket2" {
  %key = alloca i32, align 4
  %val = alloca i64, align 8
  %1 = bitcast %struct.sk_buff* %skb to i8*
  %2 = call i64 @llvm.eud.load.half(i8* %1, i64 12) #2
  %3 = icmp eq i64 %2, 34984
  br i1 %3, label %4, label %6

; <label>:4                                       ; preds = %0
  %5 = call i64 @llvm.eud.load.half(i8* %1, i64 16) #2
  br label %6
...
; <label>:8                                       ; preds = %6
  ...
  %10 = call i64 @llvm.eud.load.half(i8* %1, i64 %9) #2
...
; <label>:13                                      ; preds = %12
  ...
  %15 = call i64 @llvm.eud.load.half(i8* %1, i64 %14) #2
  %16 = and i64 %15, 16383
  %17 = icmp eq i64 %16, 0
...
; <label>:18                                      ; preds = %13
  ...
  %20 = call i64 @llvm.eud.load.byte(i8* %1, i64 %19) #2
...
.thread.i.i:                                      ; preds = %18, %13
  ...
  %24 = call i64 @llvm.eud.load.word(i8* %1, i64 %23) #2
  %25 = add i64 %nhoff.1.i, 16
  %26 = call i64 @llvm.eud.load.word(i8* %1, i64 %25) #2
...
; <label>:28                                      ; preds = %.thread.i.i, %18
  ...
  %31 = call i64 @llvm.eud.load.byte(i8* %1, i64 %nhoff.1.i) #2
...
; <label>:39                                      ; preds = %12
  ...
  %41 = call i64 @llvm.eud.load.byte(i8* %1, i64 %40) #2
  %42 = add i64 %nhoff.1.i, 8
  %43 = call i64 @llvm.eud.load.word(i8* %1, i64 %42) #2
  %44 = add i64 %nhoff.1.i, 12
  %45 = call i64 @llvm.eud.load.word(i8* %1, i64 %44) #2
  %46 = add i64 %nhoff.1.i, 16
  %47 = call i64 @llvm.eud.load.word(i8* %1, i64 %46) #2
  %48 = add i64 %nhoff.1.i, 20
  %49 = call i64 @llvm.eud.load.word(i8* %1, i64 %48) #2
  %50 = add i64 %nhoff.1.i, 24
  %51 = call i64 @llvm.eud.load.word(i8* %1, i64 %50) #2
  %52 = add i64 %nhoff.1.i, 28
  %53 = call i64 @llvm.eud.load.word(i8* %1, i64 %52) #2
  %54 = add i64 %nhoff.1.i, 32
  %55 = call i64 @llvm.eud.load.word(i8* %1, i64 %54) #2
  %56 = add i64 %nhoff.1.i, 36
  %57 = call i64 @llvm.eud.load.word(i8* %1, i64 %56) #2
  %58 = xor i64 %53, %51
  %59 = xor i64 %58, %55
  %60 = xor i64 %59, %57
...
; <label>:65                                      ; preds = %parse_ip.exit.i
  %66 = call i64 @llvm.eud.load.half(i8* %1, i64 %nhoff.2.i) #2
  %67 = add i64 %nhoff.2.i, 2
  %68 = call i64 @llvm.eud.load.half(i8* %1, i64 %67) #2
  %69 = and i64 %66, 1856
  %70 = icmp eq i64 %69, 0
...
; <label>:82                                      ; preds = %71
  ...
  %84 = call i64 @llvm.eud.load.half(i8* %1, i64 %83) #2
...
; <label>:87                                      ; preds = %86
  ...
  %89 = call i64 @llvm.eud.load.half(i8* %1, i64 %88) #2
  %90 = and i64 %89, 16383
  %91 = icmp eq i64 %90, 0
...
; <label>:92                                      ; preds = %87
  ...
  %94 = call i64 @llvm.eud.load.byte(i8* %1, i64 %93) #2
...
.thread.i4.i:                                     ; preds = %92, %87
  ...
  %98 = call i64 @llvm.eud.load.word(i8* %1, i64 %97) #2
  %99 = add i64 %nhoff.6.i, 16
  %100 = call i64 @llvm.eud.load.word(i8* %1, i64 %99) #2
...
; <label>:102                                     ; preds = %.thread.i4.i, %92
  ...
  %105 = call i64 @llvm.eud.load.byte(i8* %1, i64 %nhoff.6.i) #2
...
; <label>:113                                     ; preds = %86
  ...
  %115 = call i64 @llvm.eud.load.byte(i8* %1, i64 %114) #2
  %116 = add i64 %nhoff.6.i, 8
  %117 = call i64 @llvm.eud.load.word(i8* %1, i64 %116) #2
  %118 = add i64 %nhoff.6.i, 12
  %119 = call i64 @llvm.eud.load.word(i8* %1, i64 %118) #2
  %120 = add i64 %nhoff.6.i, 16
  %121 = call i64 @llvm.eud.load.word(i8* %1, i64 %120) #2
  %122 = add i64 %nhoff.6.i, 20
  %123 = call i64 @llvm.eud.load.word(i8* %1, i64 %122) #2
  %124 = add i64 %nhoff.6.i, 24
  %125 = call i64 @llvm.eud.load.word(i8* %1, i64 %124) #2
  %126 = add i64 %nhoff.6.i, 28
  %127 = call i64 @llvm.eud.load.word(i8* %1, i64 %126) #2
  %128 = add i64 %nhoff.6.i, 32
  %129 = call i64 @llvm.eud.load.word(i8* %1, i64 %128) #2
  %130 = add i64 %nhoff.6.i, 36
  %131 = call i64 @llvm.eud.load.word(i8* %1, i64 %130) #2
  %132 = xor i64 %127, %125
  %133 = xor i64 %132, %129
  %134 = xor i64 %133, %131
...
; <label>:137                                     ; preds = %parse_ip.exit.i
  ...
  %139 = call i64 @llvm.eud.load.half(i8* %1, i64 %138) #2
...
; <label>:142                                     ; preds = %137
  ...
  %144 = call i64 @llvm.eud.load.byte(i8* %1, i64 %143) #2
...
.thread.i1.i:                                     ; preds = %142, %137
  ...
  %148 = call i64 @llvm.eud.load.word(i8* %1, i64 %147) #2
  %149 = add i64 %nhoff.2.i, 16
  %150 = call i64 @llvm.eud.load.word(i8* %1, i64 %149) #2
...
; <label>:152                                     ; preds = %.thread.i1.i, %142
  ...
  %155 = call i64 @llvm.eud.load.byte(i8* %1, i64 %nhoff.2.i) #2
...
; <label>:163                                     ; preds = %parse_ip.exit.i
  ...
  %165 = call i64 @llvm.eud.load.byte(i8* %1, i64 %164) #2
  %166 = add i64 %nhoff.2.i, 8
  %167 = call i64 @llvm.eud.load.word(i8* %1, i64 %166) #2
  %168 = add i64 %nhoff.2.i, 12
  %169 = call i64 @llvm.eud.load.word(i8* %1, i64 %168) #2
  %170 = add i64 %nhoff.2.i, 16
  %171 = call i64 @llvm.eud.load.word(i8* %1, i64 %170) #2
  %172 = add i64 %nhoff.2.i, 20
  %173 = call i64 @llvm.eud.load.word(i8* %1, i64 %172) #2
  %174 = add i64 %nhoff.2.i, 24
  %175 = call i64 @llvm.eud.load.word(i8* %1, i64 %174) #2
  %176 = add i64 %nhoff.2.i, 28
  %177 = call i64 @llvm.eud.load.word(i8* %1, i64 %176) #2
  %178 = add i64 %nhoff.2.i, 32
  %179 = call i64 @llvm.eud.load.word(i8* %1, i64 %178) #2
  %180 = add i64 %nhoff.2.i, 36
  %181 = call i64 @llvm.eud.load.word(i8* %1, i64 %180) #2
  %182 = xor i64 %177, %175
  %183 = xor i64 %182, %179
  %184 = xor i64 %183, %181
...
; <label>:187                                     ; preds = %163, %159, %157, %113, %109, %107, %65, %parse_ip.exit.i
  ...
  %192 = call i64 @llvm.eud.load.word(i8* %1, i64 %191) #2
  store i32 %188, i32* %key, align 4
  %193 = bitcast i32* %key to i8*
  %194 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.eud_map_def* @hash_map to i8*), i8* %193) #2
...
; <label>:199                                     ; preds = %187
  ...
  %201 = call i32 inttoptr (i64 2 to i32 (i8*, i8*, i8*, i64)*)(i8* bitcast (%struct.eud_map_def* @hash_map to i8*), i8* %193, i8* %200, i64 0) #2
  br label %flow_dissector.exit.thread

flow_dissector.exit.thread:                       ; preds = %86, %12, %196, %199
  ret i32 0
; CHECK-LABEL: eud_prog2:
...
declare i64 @llvm.eud.load.half(i8*, i64) #1

declare i64 @llvm.eud.load.word(i8*, i64) #1

declare i64 @llvm.eud.load.byte(i8*, i64) #1

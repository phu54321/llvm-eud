...
;struct __sk_buff;
;unsigned long long
;load_byte(void *skb, unsigned long long off) asm("llvm.eud.load.byte");
;unsigned long long
;load_half(void *skb, unsigned long long off) asm("llvm.eud.load.half");
...
entry:
  ...
  %call = tail call i64 @llvm.eud.load.byte(i8* %0, i64 0)
...
entry:
  %0 = bitcast %struct.__sk_buff* %skb to i8*
  %call = tail call i64 @llvm.eud.load.half(i8* %0, i64 0)
  %conv = trunc i64 %call to i32
